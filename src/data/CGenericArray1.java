...
public class CGenericArray1<T>
{
    ...
    // ................................................
    public void setItem(int index, T p_oItem) {
    ...
    public T getNext()
    {
        ...
        if (nCurrentIndex >= this.itemCount)
            ...
            return (T)this.items[nCurrentIndex];
    }    
    //--------------------------------------------------------------------------
    // Last property
    public T getLast()
    {
        if (this.itemCount == 0)
            ...
            return (T)this.items[this.itemCount -1];
    }
    //--------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    public CGenericArray1()
    {
    }
    //--------------------------------------------------------------------------
    public CGenericArray1(int p_nPageSize) 
    {
    ...
    //--------------------------------------------------------------------------
    protected int append(T p_oItem)
    {
    ...
    //--------------------------------------------------------------------------
    protected void insert(int p_nIndex, T p_oItem)
    {
