...
public class CObjectArray
{
    ...
    //--------------------------------------------------------------------------
    // Item property
    protected Object[] items; // We make this field protected so it can be used by descendants.
    // ................................................
    public CCustomer getItem(int index) {
        return (CCustomer)this.items[index];
    }
    // ................................................
    public void setItem(int index, CCustomer p_oItem) {
        this.items[index] = p_oItem;
    }
    //--------------------------------------------------------------------------
    // Capacity property
    private int pages;
    ...
    //--------------------------------------------------------------------------
    // First and Next property
    private int nCurrentIndex = -1;
    // ................................................
    public CCustomer getFirst()
    {
        if (this.itemCount == 0)
            return null;
        else
    ...
    // ................................................
    public CCustomer getNext()
    {
        nCurrentIndex++;
        if (nCurrentIndex >= this.itemCount)
            return null;
        else
            return (CCustomer)this.items[nCurrentIndex];
    }    
    //--------------------------------------------------------------------------
    // Last property
    public CCustomer getLast()
    {
        if (this.itemCount == 0)
            return null;
        else
            return (CCustomer)this.items[this.itemCount -1];
    }
    //--------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    public CObjectArray(int p_nPageSize) 
    {
    ...
    //--------------------------------------------------------------------------
    protected int append(CCustomer p_oItem)
    {
        if (itemCount >= capacity)
            expand();
        
        int nAppendIndex = itemCount;    
    ...
    //--------------------------------------------------------------------------
    protected void insert(int p_nIndex, CCustomer p_oItem)
    {
