...
public class CStringArray 
{
    ...
    {
        String[] oArray = new String[this.itemCount];
        for (int i = 0; i < this.itemCount; i++) 
            oArray[i] = this.getItem(i);
        return oArray;
    }
    
    public CStringArray(int p_nPageSize) 
    {
    ...
    //--------------------------------------------------------------------------
    public void Append(String p_sItem)
    {
    ...
    //--------------------------------------------------------------------------
    public void Insert(int p_nIndex, String p_sItem)
    {
    ...
    public int Search(String p_sSearchValue)
    {
        int nFoundIndex = -1;
        for(int i = 0; i < this.itemCount; i++)
        {
            if (this.items[i].equals(p_sSearchValue))
            {
                nFoundIndex = i;
                break;
            }
